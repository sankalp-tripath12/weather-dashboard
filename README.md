...
Endpoint: Current Weather Data (free tier)

## ✨ Planned Features
- 🔍 Search weather by city name
- 🌦️ Filter cities by weather condition (Clear, Rain, Clouds, etc.)
- 🌡️ Sort results by temperature (high to low / low to high)
- ❤️ Save favourite cities using Local Storage
...
- Array HOFs: `filter()`, `map()`, `sort()`, `find()`
